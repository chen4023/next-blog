...
import { mockTableOfContents } from '@/mock/blog';
      ...
      <div className="grid grid-cols-[1fr_260px] gap-18">
        ...
        <section>
          <div className="space-y-4">
            <div className="space-y-2">
              <Badge>프론트엔드</Badge>
              <h1 className="text-4xl font-bold">Next.js와 Shadcn UI로 블로그 만들기 ({slug})</h1>
            </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <h2 className="text-xl font-bold py-2">시작하기</h2>
            <p>
            ...
            <h2 className="text-xl font-bold py-2">Shadcn UI 설정하기</h2>
            <p>
